          ...
          <AnimatePresence mode="popLayout">
            {filteredSkills.map((skill, i) => (
              <motion.div
                ...
                transition={{ duration: 0.35, delay: i * 0.025, type: "spring", stiffness: 250, damping: 22 }}
              ...
              >
                <div
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLDivElement).style.boxShadow = `0 0 20px rgba(126,184,247,${skill.level / 1000})`;
                  }}
                  onMouseLeave={(e) => {
